...
2. Pool
   ...
   * Timers(Pool) ! Add -> Timer(Timers) ! Add, Update -> Timers
     * Timer(Timers) ! Add -> TimerSettings(Timer) ! Add -> TimerSetting ! Add, Update -> TimerSettings
   * Heaters(Pool) ! Add -> Heater(Heaters) ! Add, Update -> Heaters
     * Heater(Heaters) ! Add -> HeaterSettings(Heater) ! Add -> HeaterSetting ! Add, Update -> HeaterSettings
3. Maintenance **
