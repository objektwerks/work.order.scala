...
final class Service(store: Store):
  ...
  def listSurfaces(poolId: Long): Either[Throwable, Seq[Surface]] = Try( store.listSurfaces() ).toEither
  ...
  def listPumps(poolId: Long): Either[Throwable, Seq[Pump]] = Try( store.listPumps() ).toEither
  ...
  def listTimers(poolId: Long): Either[Throwable, Seq[Timer]] = Try( store.listTimers() ).toEither
  ...
  def listTimerSettings(timerId: Long): Either[Throwable, Seq[TimerSetting]] = Try( store.listTimerSettings() ).toEither
  ...
  def listHeaters(poolId: Long): Either[Throwable, Seq[Heater]] = Try( store.listHeaters() ).toEither
  ...
  def listHeaterSettings(heaterId: Long): Either[Throwable, Seq[HeaterSetting]] = Try( store.listHeaterSettings() ).toEither
  ...
  def listMeasurements(poolId: Long): Either[Throwable, Seq[Measurement]] = Try( store.listMeasurements() ).toEither
  ...
  def listCleanings(poolId: Long): Either[Throwable, Seq[Cleaning]] = Try( store.listCleanings() ).toEither
  ...
  def listChemicals(poolId: Long): Either[Throwable, Seq[Chemical]] = Try( store.listChemicals() ).toEither
  ...
  def listSupplies(poolId: Long): Either[Throwable, Seq[Supply]] = Try( store.listSupplies() ).toEither
  ...
  def listRepairs(poolId: Long): Either[Throwable, Seq[Repair]] = Try( store.listRepairs() ).toEither
